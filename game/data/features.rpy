...
#
 ...
 init python:
    ...
    ## APPEARENCE
    'unremarkable': {'name': __('Unremarkable'), 'description': __("{possesive} appearence is unremarkable"), 'slot': 'appearance', 'modifiers': {}, 'image': 'miscards'},    
    'flawless': {'name': __('Flawless'), 'description': __("{pronoun} has a flawless appearence"), 'slot': 'appearance', 'modifiers': {'refinement': +1, 'hardiness': -1,}, 'image': 'miscards'},    
    'coarse': {'name': __('Coarse'), 'description': __("{pronoun} looks coarse"), 'slot': 'appearance', 'modifiers': {'hardiness': +1, 'refinement': -1,}, 'image': 'miscards'},        
    'unusual': {'name': __('Unusual'), 'description': __("{possesive} appearence is somehow unusual"), 'slot': 'appearance', 'modifiers': {'extravagance': +1, 'purity': -1,}, 'image': 'miscards'},    
    'naive': {'name': __('Naive'), 'description': __("{pronoun} looks naive"), 'slot': 'appearance', 'modifiers': {'purity': +1, 'extravagance': -1,}, 'image': 'miscards'},    
    'gentle': {'name': __('Gentle'), 'description': __("{pronoun} have a gentle appearence"), 'slot': 'appearance', 'modifiers': {'charisma': +1, 'menace': -1,}, 'image': 'miscards'},    
    'honest': {'name': __('Honest'), 'description': __("{pronoun} has a most honest appearence"), 'slot': 'appearance', 'modifiers': {'subtlety': -1, 'charisma': +1,}, 'image': 'miscards'},    
    'bold': {'name': __('Bold'), 'slot': 'appearance', 'description': __("{pronoun} looks bold"), 'modifiers': {'subtlety': -1, 'menace': +1,'refinement': +1, 'hardiness': -1,}, 'image': 'miscards'},    
    'wild': {'name': __('Wild'), 'slot': 'appearance', 'description': __("{pronoun} looks wild"), 'modifiers': {'subtlety': -1, 'menace': +1,}, 'image': 'miscards'},    
    'foxy': {'name': __('Foxy'), 'slot': 'appearance', 'description': __("{pronoun} has a foxy look"), 'modifiers': {'subtlety': +1, 'charisma': +1,}, 'image': 'miscards'},    
    'sleazy': {'name': __('Sleazy'), 'description': __("{pronoun} looks somehow sleazy"), 'slot': 'appearance', 'modifiers': {'extravagance': +1, 'purity': -1,'charisma': +1, 'competence': -1,}, 'image': 'miscards'},    
